...
export default function Step5({user, research, ethics_docs}) {
    ...
    <>
      {
        ...
        <>
         <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
             ...
             {/* Section Header */}
  <div class="mb-5">
    <h1 class="text-2xl font-bold text-gray-900">Ethics Clearance</h1>
    <p class="text-gray-600 text-sm mt-1">
      Manage ethics clearance
    </p>
  </div>
      ...
      <button type="submit" class="flex items-center gap-2 text-sm text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-md shadow-md focus:outline-none">
        ...
        <table class="w-full divide-y divide-gray-200 dark:divide-neutral-700 mt-3">
            ...
            <th scope="col" class="px-3 py-3  text-start text-xs font-bolder uppercase dark:text-neutral-500">Version #</th>
                ...
                <th scope="col" class="px-3 py-3  text-start text-xs font-bolder uppercase dark:text-neutral-500">Actions</th>
              </tr>
            </thead>
                                  ...
                                  <>
                                         ...
                                         <td class="px-3 py-3 text-balance whitespace-nowrap text-sm font-medium text-gray-700 dark:text-neutral-200">V{index+1}</td>
                                                            ...
                                                            <td class="px-3 py-3 whitespace-nowrap text-end text-sm font-medium">
                                                              ...
                                                              <span class="hover:cursor-pointer" onClick={() => deleteFile(ethics_doc.id)}>
                ...
                { ethics_docs.map((ethics_doc, index) => (
                                  <>
                                          ...
                                          <td class="px-3 py-3 text-balance whitespace-nowrap text-sm font-medium text-gray-700 dark:text-neutral-200">V{index+1}</td>
                                                            ...
                                                            <span class="hover:cursor-pointer" onClick={() => downloadDoc(ethics_doc)}> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="currentColor" d="m12 16l-5-5l1.4-1.45l2.6 2.6V4h2v8.15l2.6-2.6L17 11zm-6 4q-.825 0-1.412-.587T4 18v-3h2v3h12v-3h2v3q0 .825-.587 1.413T18 20z"/></svg></span>
                                                            </td>
                                                        </tr>          
                                  </>
                                ))}
