                                                  ...
                                                  <>
                                                          <tr class={index % 2 !== 0 ? "bg-gray-50 dark:bg-gray-800 dark:border-gray-700" : "bg-gray-200 dark:bg-gray-800 dark:border-gray-700"}>
                                                                            ...
                                                                            <td class="px-3 py-3 whitespace-nowrap text-end text-sm font-medium">
                                                                              ...
                                                                              <span class="hover:cursor-pointer" onClick={() => deleteFile(budget_doc.id)}>
                ...
                { budget_docs.map((budget_doc, index) => (
                                                  <>
                                                          <tr class={index % 2 !== 0 ? "bg-gray-50 dark:bg-gray-800 dark:border-gray-700" : "bg-gray-200 dark:bg-gray-800 dark:border-gray-700"}>
                                                                            ...
                                                                            <span class="hover:cursor-pointer" onClick={() => downloadDoc(budget_doc)}> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="currentColor" d="m12 16l-5-5l1.4-1.45l2.6 2.6V4h2v8.15l2.6-2.6L17 11zm-6 4q-.825 0-1.412-.587T4 18v-3h2v3h12v-3h2v3q0 .825-.587 1.413T18 20z"/></svg></span>
                                                                            </td>
                                                                        </tr>          
                                                  </>
                                                ))}
